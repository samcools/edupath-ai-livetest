...
<section class="ep-login" data-ep-login>
  <div class="ep-login-card">
    ...
    <img class="ep-brand-logo" src="<?php echo esc_url(EDUPATH_AI_URI.'/assets/images/edupath-logo.png'); ?>" alt="EduPath AI">
...
<button class="ep-ayanda" data-ep-ayanda aria-label="Open Ayanda assistant"><span class="ep-ayanda-avatar"><img src="<?php echo esc_url(EDUPATH_AI_URI.'/assets/images/ayanda.png'); ?>" alt="Ayanda"><i></i></span><b>Ayanda</b></button>
