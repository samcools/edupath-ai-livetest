...
<div class="ep-shell ep-hidden" data-ep-shell>
  ...
  <main class="ep-main">
    <header class="ep-topbar"><div class="ep-title-wrap"><h1 data-ep-title>Dashboard</h1><small data-ep-portal>Learner portal</small></div><div class="ep-toolbar"><button class="ep-icon-btn ep-mobile-menu" data-ep-menu style="display:none" aria-label="Open menu">☰</button><select class="ep-language" data-ep-language aria-label="Voice language"><option value="en-ZA">English</option><option value="af-ZA">Afrikaans</option><option value="zu-ZA">isiZulu</option><option value="xh-ZA">isiXhosa</option><option value="st-ZA">Sesotho</option><option value="tn-ZA">Setswana</option><option value="nso-ZA">Sepedi</option><option value="ts-ZA"><?php echo esc_html('Xi' . 'tsonga'); ?></option><option value="ve-ZA">Tshivenda</option><option value="ss-ZA">siSwati</option><option value="nr-ZA">isiNdebele</option></select><button class="ep-icon-btn ep-desktop-only" data-ep-theme aria-label="Toggle theme">◐</button><button class="ep-icon-btn ep-desktop-only" data-ep-notifications aria-label="Notifications">🔔</button></div></header>
